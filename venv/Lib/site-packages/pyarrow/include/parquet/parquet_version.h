...
#define PARQUET_VERSION_MAJOR 17
#define PARQUET_VERSION_MINOR 0
#define PARQUET_VERSION_PATCH 0

#define PARQUET_SO_VERSION "1700"
#define PARQUET_FULL_SO_VERSION "1700.0.0"

// define the parquet created by version
#define CREATED_BY_VERSION "parquet-cpp-arrow version 17.0.0"
